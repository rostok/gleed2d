    ...
    class Editor
    {
        ...
        public void updatetreeview()
        {
            ...
            foreach (Layer layer in level.Layers)
            {
                ...
                if (layer.Expanded) layernode.Expand();
            }
        ...
        public void update(GameTime gt)
        {
            ...
            // rostok
            if (mstate.LeftButton == ButtonState.Pressed) MainForm.Instance.toolStripStatusLabel3.Text += " Delta (" + (mouseworldpos.X-grabbedpoint.X) + ", " + (mouseworldpos.Y-grabbedpoint.Y) + ")";
            camera.Position = maincameraposition;
        ...
        public void draw(SpriteBatch sb)
        {
            ...
            foreach (Layer l in level.Layers)
            {
                ...
                sb.Begin(SpriteSortMode.Deferred, BlendState.NonPremultiplied, MainForm.Instance.antialiasswitch.Checked ? SamplerState.PointClamp : null, null, null, null,
                  camera.matrix);
