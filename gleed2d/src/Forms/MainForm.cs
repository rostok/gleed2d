...
namespace GLEED2D
{
    public partial class MainForm : Form
    {
        ...
        private void treeView1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.F6) this.collapseButton_Click(sender, e);
        ...
        private void FileOpen(object sender, EventArgs e)
        {
            ...
            if (opendialog.ShowDialog() == DialogResult.OK)
            {
                ...
                //Constants.Instance.import(Path.GetDirectoryName(opendialog.FileName) , "settings.xml");
            }
        }
        private void FileSave(object sender, EventArgs e)
        {
            ...
            {
                saveLevel(levelfilename);
                //Constants.Instance.export(Path.GetDirectoryName(levelfilename), "settings.xml");
            }
        ...
        public void loadfolder_foreground(string path)
        {
            ...
            textBox1.Text = di.FullName; // this triggers loadFolder
            listView1.Clear();
        ...
        private void collapseButton_Click(object sender, EventArgs ea)
        {
            try
            {
        ...
        private void treeView1_AfterExpand(object sender, TreeViewEventArgs e)
        {
            ...
            {
                Layer l = (Layer)e.Node.Tag;
                l.Expanded = e.Node.IsExpanded;
            }
        }

        private void antialiasswitch_Click(object sender, EventArgs e)
        {
            antialiasswitch.Checked = !antialiasswitch.Checked;
            antialiasswitch.Text = antialiasswitch.Checked ? "No AA" : "AA";
        }
