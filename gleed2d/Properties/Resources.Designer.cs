...
namespace GLEED2D.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to (Left Click or 1) = next point      (BackSpace) = delete last point      (Middle Click or 2) = add path to level      (Right Click or 3) = cancel path.
        /// </summary>
